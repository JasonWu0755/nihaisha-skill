...
| [`references/shanghanlun.md`](./references/shanghanlun.md) | 《伤寒论》课程总纲旧版整合文档。 |
| [`scripts/search_screenshots.py`](./scripts/search_screenshots.py) | 跨模块截图证据排序检索脚本。 |
| [`assets/screenshots`](./assets/screenshots) | 压缩后的课程截图图片，按课程模块分目录存放。 |
